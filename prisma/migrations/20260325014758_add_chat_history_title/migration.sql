...
INSERT INTO "new_ChatHistory" ("createdAt", "id", "modelId", "providerId", "role", "updatedAt", "userId") SELECT "createdAt", "id", "modelId", "providerId", "role", "updatedAt", "userId" FROM "ChatHistory";
